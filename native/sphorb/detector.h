...
xy* sfast_corner_detect(const unsigned char* im, const unsigned char* mask, int xsize, int xstride, int ysize, int barrier, int* num);

int sfast_corner_score(const unsigned char* im, const int pixel[], int bstart);
