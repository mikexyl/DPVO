...
# Reuse the validated 302_4 through 302_16 tracking artifacts, track 302_17 as
# robot13, then run the robot-count-independent verification and DPGO stages.
...
DPVO_DATA_ROOT="${DPVO_IPHONE_ROOT:-/data3/dpvo_cbs_ws/data/iphone_302_17_fourteen_robot_20260901}"
DPVO_RESULTS="${DPVO_RESULTS_ROOT:-/data3/dpvo_cbs_ws/results}"
DPVO_RESULT_TAG="${DPVO_OUTPUT_TAG:-iphone_302_4_5_6_7_8_9_10_11_12_13_14_15_16_17_full_min18_fourteen_robot_20260901}"
DPVO_REUSE_ARTIFACT_ROOT="${DPVO_REUSE_ARTIFACT_ROOT:-/data3/dpvo_cbs_ws/results/iphone_302_4_5_6_7_8_9_10_11_12_13_14_15_16_full_min18_thirteen_robot_20260831/tracking}"
...
DPVO_ROS_INSTALL="${DPVO_ROS_INSTALL:-$DPVO_DEPLOY_ROOT/build/ros2-install}"
...
export DPVO_MIN_INLIERS="${DPVO_MIN_INLIERS:-18}"
...
export CUDA_MPS_PIPE_DIRECTORY="${CUDA_MPS_PIPE_DIRECTORY:-/tmp/dpvo-iphone-fourteen-robot-mps-pipe}"
export CUDA_MPS_LOG_DIRECTORY="${CUDA_MPS_LOG_DIRECTORY:-/tmp/dpvo-iphone-fourteen-robot-mps-log}"
...
run_stage1() {
  echo "[stage1] Reusing robots0-12 and tracking 302_17 as robot13"
  mkdir -p "$ARTIFACT_ROOT"
  for robot_id in \
    robot0 robot1 robot2 robot3 robot4 robot5 robot6 \
    robot7 robot8 robot9 robot10 robot11 robot12
  do
  ...
  source "$DPVO_ROS_INSTALL/setup.bash"
  set -u
  rerun_args=()
  ...
  ros2 launch dpvo_multi_robot robot13_tum_track.launch.py \
    dataset_root:="$DPVO_DATA_ROOT" \
    sequence0:="${DPVO_IPHONE_SEQUENCE13:-302_17}" \
