...
# Reuse the validated 302_4 through 302_14 tracking artifacts, track 302_15 as
# robot11, then run the robot-count-independent verification and DPGO stages.
...
DPVO_DATA_ROOT="${DPVO_IPHONE_ROOT:-/data3/dpvo_cbs_ws/data/iphone_302_15_twelve_robot_20260831}"
DPVO_RESULTS="${DPVO_RESULTS_ROOT:-/data3/dpvo_cbs_ws/results}"
DPVO_RESULT_TAG="${DPVO_OUTPUT_TAG:-iphone_302_4_5_6_7_8_9_10_11_12_13_14_15_full_min16_twelve_robot_20260831}"
DPVO_REUSE_ARTIFACT_ROOT="${DPVO_REUSE_ARTIFACT_ROOT:-/data3/dpvo_cbs_ws/results/iphone_302_4_5_6_7_8_9_10_11_12_13_14_full127_min16_eleven_robot_20260831/tracking}"
...
export CUDA_MPS_PIPE_DIRECTORY="${CUDA_MPS_PIPE_DIRECTORY:-/tmp/dpvo-iphone-twelve-robot-mps-pipe}"
export CUDA_MPS_LOG_DIRECTORY="${CUDA_MPS_LOG_DIRECTORY:-/tmp/dpvo-iphone-twelve-robot-mps-log}"
...
run_stage1() {
  echo "[stage1] Reusing robots0-10 and tracking 302_15 as robot11"
  mkdir -p "$ARTIFACT_ROOT"
  for robot_id in \
    robot0 robot1 robot2 robot3 robot4 robot5 robot6 robot7 robot8 robot9 robot10
  do
  ...
  ros2 launch dpvo_multi_robot robot11_tum_track.launch.py \
    dataset_root:="$DPVO_DATA_ROOT" \
    sequence0:="${DPVO_IPHONE_SEQUENCE11:-302_15}" \
