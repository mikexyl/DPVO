"""Stage-one four-robot DPVO tracking with no inter-robot verification."""
...
def generate_launch_description():
    arguments = [
        ...
        *[
            DeclareLaunchArgument(f"sequence{robot_index}")
        ...
        DeclareLaunchArgument(
            "rerun_recording_id", default_value="dpvo-four-robot-offline-tracking"
        ),
    ]
